...
func (s *Server) Handler() http.Handler {
	...
	mux.HandleFunc("/knowledge", s.requireAuth(s.handleKnowledge))
	mux.HandleFunc("/knowledge-save", s.requireAuth(s.requirePost(s.handleKnowledgeSave)))
	mux.HandleFunc("/knowledge-del", s.requireAuth(s.requirePost(s.handleKnowledgeDel)))
	mux.HandleFunc("/knowledge-preview", s.requireAuth(s.requirePost(s.handleKnowledgePreview)))
